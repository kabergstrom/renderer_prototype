...
impl RafxApiEmpty {
    pub fn device_context(&self) -> &RafxDeviceContextEmpty {
        unimplemented!()
    }
...
impl RafxDeviceContextEmpty {
    ...
    pub fn create_shader_module(
        &self,
        data: RafxShaderModuleDefEmpty,
    ) -> RafxResult<RafxShaderModuleEmpty> {
        unimplemented!();
    }

    pub fn wait_for_fences(
        &self,
        fences: &[&RafxFenceEmpty],
    ) -> RafxResult<()> {
        unimplemented!();
    }
...
impl RafxDescriptorSetArrayEmpty {
    pub fn handle(
        &self,
        array_index: u32,
    ) -> Option<RafxDescriptorSetHandleEmpty> {
        unimplemented!();
    }
    pub fn root_signature(&self) -> &RafxRootSignature {
        unimplemented!();
...
impl RafxQueueEmpty {
    ...
    ) -> RafxResult<RafxCommandPoolEmpty> {
        unimplemented!();
    }
    pub fn submit(
        &self,
        command_buffers: &[&RafxCommandBufferEmpty],
        wait_semaphores: &[&RafxSemaphoreEmpty],
        signal_semaphores: &[&RafxSemaphoreEmpty],
        signal_fence: Option<&RafxFenceEmpty>,
    ) -> RafxResult<()> {
        unimplemented!();
    }
    pub fn present(
        &self,
        swapchain: &RafxSwapchainEmpty,
        wait_semaphores: &[&RafxSemaphoreEmpty],
        image_index: u32,
...
impl RafxCommandPoolEmpty {
    ...
    ) -> RafxResult<RafxCommandBufferEmpty> {
        unimplemented!()
    }
...
impl RafxCommandBufferEmpty {
    ...
    pub fn cmd_draw_indirect(
        &self,
        indirect_buffer: &RafxBufferEmpty,
...
impl RafxFenceEmpty {
    ...
    pub fn wait_for_fences(
        device_context: &RafxDeviceContextEmpty,
        fences: &[&RafxFenceEmpty],
    ) -> RafxResult<()> {
        unimplemented!();
    }
